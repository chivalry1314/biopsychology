  ...
  <div class="quantum-panel p-5 relative overflow-hidden flex flex-col h-full">
    <div>
      <h3 class="text-sm font-bold text-slate-300 mb-4 flex items-center justify-between">
        ...
        <span class="text-xs text-purple-400 font-mono-tech">DASHBOARD</span>
      </h3>
      ...
      <div class="space-y-4">
        <div v-for="nt in neurotransmitters" :key="nt.key">
          <div class="flex justify-between text-xs mb-1">
            ...
            <span class="font-mono-tech font-semibold" :style="{ color: nt.hex }">{{ levels[nt.key] }}%</span>
          </div>
    ...
    <div class="mt-6 pt-4 border-t border-slate-900">
      <div class="rounded-lg bg-slate-900/50 p-3 border border-slate-800/60">
        <span class="text-[10px] text-slate-500 font-mono-tech block mb-1">当前主导心理状态:</span>
